...
@ApiResponses(value = {
        ...
        @ApiResponse(code = 500, message = "The server is down. Please check the server is running."),
        @ApiResponse(code = 204, message = "No cars found. Please check your criteria.")
}
)
@RequestMapping("/cars")
class CarController {
